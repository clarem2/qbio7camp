...
In this data analysis, we wanted to see if there was any relation to how many female smokers there are and how many new covid cases there are each day. What we found, both with p values < 0.05, is that on January 23rd and 24th of 2020, these values were positively correlated. This could potentially prove that in January, there were so many female smokers that there was too much smoke in the air, this weakened surrounding peoples' lungs, and made them more susceptible to covid, causing the spike in cases. In reality, we set up an algorithm to pull data from dates until this correlation was found significantly. This is inherently biased. 
